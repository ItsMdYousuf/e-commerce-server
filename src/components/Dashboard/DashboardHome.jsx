...
const DashboardHome = () => {
 ...
 <StatusGraph totalNumber="44465632" percentNumber="33" yearlyCount="44554" subTitle="total users" upOrDown="up" /> <StatusGraph totalNumber="44465632" percentNumber="33" yearlyCount="44554" subTitle="total users" upOrDown="down" /> 
